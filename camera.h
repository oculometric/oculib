...
public:
	inline OLMatrix4f getProjectionMatrix()
	{
    	return projectionMatrix(near_clip, far_clip, horizontal_fov, aspect_ratio);
	}

	inline static OLMatrix4f projectionMatrix(float near_clip_plane, float far_clip_plane, float horizontal_fov_degrees, float aspect_ratio)
	{
